    ...
    <>
      <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
        <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
          {resumeModalOpen && (
            <ResumeModal close={() => setResumeModalOpen(!resumeModalOpen)} />
          )}
          ...
          >
            <div className="tooltip">
              <i
                className={`${
                  text !== "dark" ? "text-white" : "text-blueGrey-600"
                } fas ${
                  lang == "english" ? "fa-arrow-left " : "fa-arrow-right "
                }`}
              ></i>
              <span className="tooltiptext">
                {lang == "english" ? "Back" : "بازگشت"}
              </span>
            </div>
          </button>
          <div className="text-center text-white text-sm font-bold leading-relaxed inline-block px-3 py-1 whitespace-nowrap uppercase">
            <img
              src={process.env.imagesPrefix + "/img/azarshiga/azarshiga.png"}
        ...
        >
          ...
          <ul
            className={`flex flex-col lg:flex-row list-none ${
              lang == "english" ? "lg:ml-auto" : "lg:mr-auto"
            }`}
          >
            <li className="flex items-center">
